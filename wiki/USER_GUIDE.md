...
* **Referral Program**: Invite friends to join Quantum Yoga. As they enroll, you move up referral tiers to receive discounts on subscriptions.
...
* **User Management**: View, filter, and manage all registered student profiles.
