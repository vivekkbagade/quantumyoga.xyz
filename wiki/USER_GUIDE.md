...
* **Browse Catalog**: Discover an interactive list of yoga poses with difficulty indicators, benefits, and step-by-step descriptions.
* **Favorites**: Save your favorite poses and routines to a curated favorites list for quick access.
* **Practice Routines**: Select custom sequences and initiate the step-by-step playback player. The interface guides you through breathing patterns, duration timers, and visual transitions.

### 1.2 Student Profile & Settings
...
* **User Management**: View, filter, manage, or delete registered student profiles.
* **Class Batches**: Configure, edit, or delete class batches, adjust capacities, assign instructors, and set timetables.

### 2.2 Billing & Reconciliations
* Monitor invoice payments, approve payment claims, or process refunds.
* **Auto-Reconciliation**: Import bank statement ledgers to automatically match transaction IDs against outstanding invoices based on customizable date and amount tolerance thresholds.
